    ...
    <>
      <div className="min-h-[calc(100vh-96px)] w-full flex justify-center items-center">
        <div className="w-4/5 h-fit flex justify-between items-center p-4 gap-16">
          <div className="w-1/2 h-96 flex flex-col gap-14 justify-center">
            ...
            <div className="flex justify-evenly items-center gap-2">
              <ul className="text-2xl font-fira text-balance gap-2 flex flex-col border-2 rounded-xl px-6 py-4 list-none cursor-pointer">
          ...
          <div className="w-1/2 h-96 bg-zinc-900 rounded-lg">
